...
parser.add_argument("--model", default="checkpoint/model_epoch_15.pth", type=str, help="model path")
parser.add_argument("--image", default="img_033_x4", type=str, help="image name")
...
im_gt_y = sio.loadmat("Urban100/" + opt.image + ".mat")['im_gt_y']
im_b_y = sio.loadmat("Urban100/" + opt.image + ".mat")['im_b_y']
im_l_y = sio.loadmat("Urban100/" + opt.image + ".mat")['im_l_y']
